...
namespace SimpleClassicTheme.SetupWizard
{
    partial class InstallOptionsPage
    {
        ...
        private void InitializeComponent()
        {
			...
			this.groupBox1.Text = "Classic Taskbar options";
			// 
			// label3
			// 
			...
			this.label3.Text = "For example, ROS Explorer users.";
			// 
			// radioButton3
			// 
			...
			this.radioButton3.Text = "Do not install any Classic Taskbar solution";
			...
			this.label2.Text = "SCT Taskbar is still in beta and may feature unexpected issues.";
			// 
			// radioButton2
			// 
			...
			this.radioButton2.Text = "Simple Classic Theme Taskbar";
			...
			this.label1.Text = "StartIsBack++ is paid software with a 30-day trial.";
			// 
			// radioButton1
			// 
			this.radioButton1.AutoSize = true;
			this.radioButton1.Location = new System.Drawing.Point(9, 56);
			this.radioButton1.Name = "radioButton1";
			this.radioButton1.Size = new System.Drawing.Size(327, 17);
			this.radioButton1.TabIndex = 1;
			this.radioButton1.Text = "Open-Shell with StartIsBack++ configured as a Classic Taskbar";
			...
			this.checkBox3.Text = "Install extra Classic Theme utilites. (Will be on next page)";
			...
			this.checkBox2.Size = new System.Drawing.Size(423, 17);
			this.checkBox2.TabIndex = 1;
			this.checkBox2.Text = "Run SCT when your computer starts, enable Classic Theme and check for updates.";
			...
			this.NextButtonText = "&Install";
			this.PageParts = Craftplacer.ClassicSuite.Wizards.Enums.PageParts.Header;
			this.Size = new System.Drawing.Size(497, 253);
			this.Subtitle = "Select the program features you want installed.";
			this.Title = "Installation options";
			this.EnterPage += new System.EventHandler<System.EventArgs>(this.InstallOptionsPage_EnterPage);
			this.LeavePage += new System.EventHandler<System.EventArgs>(this.InstallOptionsPage_LeavePage);
