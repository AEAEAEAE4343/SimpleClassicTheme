...
namespace SimpleClassicTheme
{
    public abstract class InstallableUtility
    {
        ...
        public static InstallableUtilityWithInstallerFromResource 	ClassicTaskManager			= new InstallableUtilityWithInstallerFromResource(	"Classic Task Manager", 	"ctm.exe", 			"setup_classic-taskmgr",									    		ApplicationEntryPoint.ProgramFiles + "\\ClassicTaskmgr",						ApplicationEntryPoint.ProgramFiles + "\\ClassicTaskmgr\\unins000.exe",							            "/silent",					(ApplicationEntryPoint.ProgramFiles + "\\ClassicTaskmgr\\unins000.exe",								"/silent"));
        public static InstallableUtilityWithInstallerFromResource 	FolderOptionsX				= new InstallableUtilityWithInstallerFromResource(	"Folder Options X",		 	"fox.exe", 			"setup_folder-options-x",										    	ApplicationEntryPoint.ProgramFiles + "\\T800 Productions\\Folder Options X",	ApplicationEntryPoint.ProgramFiles + "\\T800 Productions\\Folder Options X\\unins000.exe",		            "/silent",					(ApplicationEntryPoint.ProgramFiles + "\\T800 Productions\\Folder Options X\\unins000.exe",			"/silent"));
        public static InstallableUtilityWithInstallerFromResource   OpenShell                   = new InstallableUtilityWithInstallerFromResource(  "Open-Shell",               "oss.exe",          "setup_open-shell",                                                     ApplicationEntryPoint.ProgramFiles + "\\Open-Shell",                            ApplicationEntryPoint.ProgramFiles + "\\Open-Shell\\OpenShell.chm",                                         "/qn /norestart",           (ApplicationEntryPoint.windir + "\\System32\\msiexec.exe",                                          "/X{FD722BB1-4960-455F-89C6-EFAEB79527EF} /qn /norestart"));
